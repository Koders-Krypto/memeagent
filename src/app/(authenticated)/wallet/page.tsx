...
import { Loader2, RefreshCw, Send, Wallet, X, Copy, ExternalLink, Scan } from 'lucide-react'
            ...
            <div className="space-y-6">
                ...
                >
                    <button
                        ...
                        className="flex items-center justify-center space-x-2 p-4 bg-primary text-white rounded-xl hover:bg-primary/90 transition-colors"
                    >
