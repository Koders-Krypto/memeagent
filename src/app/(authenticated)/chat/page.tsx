    ...
    return (
        <div className="flex flex-col h-[calc(100vh-80px)]">
            ...
            <div
                ...
                className="flex-1 overflow-hidden px-4 md:px-0 mx-auto w-full max-w-4xl"
            >
                        ...
                        <div className="space-y-6">
                            {messages.length > 0 ? (
                                messages.map((message) => (
                                    ...
                                    >
                                        <div
                                            className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${message.role === "human" ? "bg-primary" : "bg-gray-700"
                                                }`}
                                        >
                                            {message.role === "human" ? (
                                        ...
                                        <div
                                            className={`flex-1 max-w-full p-4 rounded-2xl break-words ${message.role === "human"
