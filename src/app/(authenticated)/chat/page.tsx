  ...
  return (
    <div className="flex flex-col h-[calc(100vh-11rem)]">
      <div
        ...
        className="flex-1 overflow-hidden px-4 pt-4 mx-auto w-full max-w-4xl"
      >
      ...
      <div className="flex-none px-4 py-4">
        <div className="relative max-w-4xl mx-auto flex flex-row justify-between items-center bg-slate-800 border border-gray-700 rounded-full w-full  px-3 py-2.5">
          <input
            ...
            disabled={loading}
            className="w-full bg-transparent rounded-2xl pl-1 pr-3 focus:outline-none focus:ring-0 transition-all"
          />

          <button
            onClick={handleSubmit}
            disabled={loading || !userInput.trim()}
            className="bg-primary text-black rounded-full p-2 border border-primary hover:bg-transparent hover:text-primary transition-colors"
          >
            {loading ? (
