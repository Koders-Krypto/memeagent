                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-black flex items-center justify-center">
                            <Image src="/agent.svg" alt="Meme Agent" width={24} height={24} className="text-black" />
                        </div>
                        <div>
                        ...
                        <div className="space-y-6">
                            {messages.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        >
                                            {message.role === "human" ? (
                                                ...
                                                <Image src="/agent.svg" alt="Meme Agent" width={18} height={18} className="text-primary" />
                                            )}
                                        </div>
                                        <div
                                ...
                                <div className="h-full flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 space-y-4">
                                    <Image src="/agent.svg" alt="Meme Agent" width={12} height={12} className="opacity-50" />
